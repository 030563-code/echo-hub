      ...
      {canEdit && (
        <div className="flex items-center justify-between mt-4">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-5 py-3 sm:py-2 bg-[#FF7026] hover:bg-[#f2641b] disabled:opacity-50 text-white text-sm font-medium rounded-lg transition-colors"
          >
