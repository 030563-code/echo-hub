  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-500 text-sm mt-1">Live stock levels across EB-SRO and North American depots</p>
      </div>

      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
        {[
          { label: "Total SKUs", value: totalSkus, color: "text-gray-900" },
          { label: "Total Units", value: totalUnits, color: "text-echo-orange" },
          { label: "Zero Stock", value: zeroStock, color: zeroStock > 0 ? "text-red-700" : "text-emerald-700" },
          { label: "Low Stock (<10)", value: lowStock, color: lowStock > 0 ? "text-amber-700" : "text-emerald-700" },
