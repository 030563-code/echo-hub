...
export default function ManufacturingCard({
  ...
  // 🔴 EXTRA addresses. The manufacturer's own address and the four internal copies are decided on
  // the server and always go; these are ADDED to them and cannot remove one. Dean, 17 Sep 2026:
  // "readd the ability to enter email addresses for to and CC which will append to the existing
