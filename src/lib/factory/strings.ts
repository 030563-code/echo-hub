...
const en: FactoryStrings = {
  ...
  ordersIntro:
    'Purchase orders sent to you. Open one to download it, confirm it with your dates, and press Manufacturing finished once the whole order is manufactured and packed.',
  ...
  step3BodyLead: 'Press this when ',
  step3BodyStrong: 'the whole order is manufactured and packed',
  step3BodyTail: ', so we can arrange the collection.',
  step3ConfirmFirst: 'Confirm the purchase order first.',
  ...
  errConfirmFirst: 'Confirm the purchase order first.',
...
const sk: FactoryStrings = {
  ...
  ordersTitle: 'Výroba',
  ordersIntro:
    'Objednávky, ktoré sme vám poslali. Otvorte objednávku, stiahnite si ju, potvrďte ju s vašimi termínmi a keď je celá vyrobená a zabalená, stlačte Výroba dokončená.',
  ...
  step3BodyLead: 'Stlačte toto tlačidlo, keď je ',
  step3BodyStrong: 'celá objednávka vyrobená a zabalená',
  step3BodyTail: ', aby sme mohli zorganizovať jej vyzdvihnutie.',
  step3ConfirmFirst: 'Najprv potvrďte objednávku.',
  ...
  errConfirmFirst: 'Najprv potvrďte objednávku.',
