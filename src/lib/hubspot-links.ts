 ...
 * form: record/0-3 deals, 0-2 companies, 0-1 contacts. There is NO quote
 * kind: HubSpot has no record page for a quote, and record/0-14/{id} opened
 * nothing when Dean clicked it on 15 Sep 2026. A quote is reached through its
 * deal, or through its own public link.
 *
