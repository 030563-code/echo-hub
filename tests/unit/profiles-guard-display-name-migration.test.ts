...
const UP = 'supabase/migrations/pending/20260914120000_profiles_guard_display_name.sql'
const DOWN = 'supabase/migrations/rollback/20260914120000_profiles_guard_display_name.down.sql'
